...
//#define ATK_MS901M_UART_TX_GPIO_AF              GPIO_AF7_USART1
//#define ATK_MS901M_UART_TX_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)     /* PB口时钟使能 */
                                                
#define ATK_MS901M_UART_RX_GPIO_PORT            GPIOA
#define ATK_MS901M_UART_RX_GPIO_PIN             GPIO_PIN_10
//#define ATK_MS901M_UART_RX_GPIO_AF              GPIO_AF7_USART1
//#define ATK_MS901M_UART_RX_GPIO_CLK_ENABLE()    do{ __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)     /* PB口时钟使能 */
...
//#define ATK_MS901M_UART_CLK_ENABLE()            do{ __HAL_RCC_USART1_CLK_ENABLE(); }while(0)    /* USART3 时钟使能 */
